...
int player59::count=-1;
int player59::spiral_safe=1;
int player59::spiral_wont_work()
{
    spiral_safe=0;
}
int player59::getcount()
{
    return ++count;
}

int player59::SNM(char board[BOARD_LENGHT][BOARD_BREADTH],int head_positiony,int head_positionx ,int acc_direction,int life_left)
{
...
bool player59::checkvoid(char board[BOARD_LENGHT][BOARD_BREADTH],int heady,int headx,int dir)
{
	int up,down;
	if(dir==LEFT)
	{
